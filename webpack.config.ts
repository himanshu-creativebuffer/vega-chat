...
const DEFAULT_APP_TITLE = `VEGA Chat${APP_ENV !== 'production' ? ' Beta' : ''}`;
...
const CSP = `
  ...
  img-src 'self' data: blob: https://d2o3vfthn32wv7.cloudfront.net/ https://ss3.4sqi.net/img/categories_v2/
