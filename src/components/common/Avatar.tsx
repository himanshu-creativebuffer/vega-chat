...
const Avatar: FC<OwnProps> = ({
  ...
  const transitionClassNames = useMediaTransition(hasBlobUrl || profilePhoto?.length);
  ...
  const fullClassName = buildClassName(
    ...
    onClick && 'interactive',
    (!isSavedMessages && !imgBlobUrl && !profilePhoto) && 'no-photo',
  );
  ...
  return (
    <div
      ...
      aria-label={typeof content === 'string' && !profilePhoto ? author : undefined}
      onClick={handleClick}
