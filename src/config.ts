...
export const VEGA_USERS_BASE_URL = 'http://user-r-servi-xuvkgjuxiil3-ecd17f2b5281495d.elb.ap-southeast-1.amazonaws.com';
...
export const LIGHT_THEME_BG_COLOR = '#ffffff';
export const DARK_THEME_BG_COLOR = '#0F0F0F';
export const DEFAULT_PATTERN_COLOR = '#4471a98c';
